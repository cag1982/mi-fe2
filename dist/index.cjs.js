...
var socials = [
    {
        label: "Github",
        icon: "GithubIcon",
        href: "https://github.com/dojofarm/kunai-contracts-polygon",
    },
    {
        label: "Docs",
        icon: "DocsIcon",
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(PriceBox, null, cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
            ...
            React__default['default'].createElement(Text, { color: "#382673", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }))),
        React__default['default'].createElement(SocialEntry, null, socials.map(function (social, index) {
            var Icon = Icons$1[social.icon];
            var iconProps = { width: "32px", color: "#382673", style: { cursor: "pointer" } };
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#382673", backgroundDisabled: "#C4C4C4", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#170358", tertiary: "rgba(255, 255, 255, .2)", text: "#FFFFFF", textDisabled: "#6E648E", textSubtle: "#FCE9F2", borderColor: "#E9EAEB", card: "#5137A6", gradients: {
        bubblegum: "linear-gradient(139.73deg, #5137A6 0%, #10114C 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#382673", backgroundDisabled: "#C4C4C4", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#170358", tertiary: "rgba(255, 255, 255, .2)", text: "#FFFFFF", textDisabled: "#6E648E", textSubtle: "#FCE9F2", borderColor: "#E9EAEB", card: "#5137A6", gradients: {
        bubblegum: "linear-gradient(139.73deg, #5137A6 0%, #10114C 100%)",
    } });
